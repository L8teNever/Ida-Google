...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "Keep-Notizen, Docs, Sheets, Slides, Chat, Meet -- weitere kommen "
        "dazu) -- alle fuer genau den einen Google-Account, der einmalig "
        "ueber den separaten Auth-Port verbunden wurde. "
        "google_verbindung_status zuerst aufrufen, wenn ein Tool einen "
        "Verbindungsfehler meldet -- zeigt, ob die Google-Anmeldung "
        "ueberhaupt schon gemacht wurde. google_mail_senden und "
        "google_chat_nachricht_senden verschicken sofort und unwiderruflich "
        "-- vor dem Senden immer den Inhalt mit dem Nutzer bestaetigen, "
        "nicht eigenmaechtig senden."
    ),
